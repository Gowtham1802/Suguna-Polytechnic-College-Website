    ...
    <div>
      <div className="">
        <div className="sm:w-full sm:h-full md:w-full md:h-full lg:w-full lg:h-full xl:w-full xl:h-full ">
          <img
            className="sm:w-full sm:h-[36rem] md:w-full md:h-[36rem] lg:w-full lg:h-[35rem] xl:w-[100%] xl:h-[35rem] "
            src={AboutImg}
            alt="about-img"
          />
        </div>
        <div className="sm:flex sm:items-center sm:justify-start  sm:bg-[#83acb0] sm:h-[3rem] w-full flex flex-col justify-start items-start  bg-[#83acb0] ">
          <ul className="w-full flex sm:w-full sm:flex sm:justify-start sm:items-start sm:gap-1 sm:font-normal sm:text-[18px]">
            <li className="sm:justify-center sm:items-center sm:hover:text-[#f98d2f]">
              ...
              >
                Home{" "}
                <FiChevronsRight className="pt-1 text-[1.4rem] sm:pt-1 sm:text-[1.4rem] xl:text-[1.5rem]" />
              </a>{" "}
            </li>
            <li className="sm:hover:text-[#f98d2f] xl:text-[1.5rem]">About</li>
          </ul>
        </div>
        <div className="pt-2rem sm:pt-[2rem] sm:justify-between sm:items-center lg:w-full xl:flex xl:justify-evenly xl:items-center xl:gap-6  ">
          <img
        ...
        <div className="sm:pt-[2rem] sm:flex sm:flex-col sm:justify-between sm:items-center md:flex md:flex-col lg:w-full lg:flex lg:flex-col xl:flex xl:flex-row xl:justify-evenly xl:items-center">
          ...
          <img
            className="lg:w-full xl:w-[50%] xl:h-[35rem] xl:pl-5 xl:order-last sm:order-first"
            src={AboutImg2}
            alt=""
          />
        </div>
