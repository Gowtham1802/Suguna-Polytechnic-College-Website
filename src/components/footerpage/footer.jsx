    ...
    <div>
      <div className="w-full bg-black flex flex-col justify-start overflow-x-hidden sm:overflow-x-hidden md:overflow-x-hidden lg:overflow-x-hidden xl:overflow-x-hidden 2xl:overflow-x-hidden ">
        <div className="w-full flex flex-col justify-start items-center sm:flex-col sm:justify-center lg:w-full lg:flex-row lg:justify-start ">
          <div className="w-[28%] flex flex-col gap-8 items-center sm:w-[100%] lg:w-[28%] lg:px-[2rem] lg:gap-5 ">
          ...
          <div className="w-[24%] flex sm:w-[100%] sm-flex sm:flex-col sm:items-center sm:text-center sm:justify-center lg:w-[48%] lg:flex lg:flex-row">
            <div className="lg:w-[50%] sm:w-[30%]">
              <h1 className="text-white text-[2rem] font-bold lg:text-[1.5rem] text-left">
                Quick Links
              </h1>
            ...
            <div className="w-[24%] pt-[rem] pb-[3rem] flex sm:w-[30%] sm:flex-col sm:items-start sm:relative lg:pt-[6rem] lg:flex-col lg:justify-start lg:items-start lg:w-[50%] ">
              <ul className="text-white text-[20px] lg:justify-start lg:items-start  lg:text-[18px] lg:pl-[7.2rem]">
                <li className="hover:text-[#ff9637] cursor-pointer pb-2">
                  <a
                    className="flex items-center lg:justify-start gap-2 hover:scale-[0.9] transition-all duration-[600ms]"
                    href=""
                  >
                    <IoIosArrowForward className="text-[20px]"></IoIosArrowForward>
                    Admission
          ...
          <div className="w-[25%] sm:w-[100%] sm:flex sm:justify-start sm:items-center sm:flex-col sm:pt-[0rem] lg:w-[28%]">
            ...
            <ul className="text-[white] text-[20px] sm:justify-start sm:items-center lg:text-[18px]">
              <li className="hover:text-[#ff9637] cursor-pointer pb-2">
                <a
                  className="flex items-center gap-2 hover:scale-[0.9] transition-all duration-[600ms]"
                  href=""
        ...
        <div className="w-full flex flex-row justify-evenly items-center sm:flex-col sm:gap-4 lg:flex lg:flex-row lg:justify-evenly lg:items-center">
